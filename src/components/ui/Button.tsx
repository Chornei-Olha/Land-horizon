...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({
  ...
  const variants = {
    primary: 'bg-button-1 text-global-10 hover:opacity-90 active:opacity-80 focus:ring-button-1',
    secondary:
      'bg-global-15 text-global-8 hover:bg-global-14 active:bg-global-13 focus:ring-global-13',
    outline:
      'border border-global-13 text-global-8 bg-transparent hover:bg-global-14 active:bg-global-13 focus:ring-global-13',
    ghost:
      'text-global-8 bg-transparent hover:bg-global-14 active:bg-global-13 focus:ring-global-13',
    danger: 'bg-global-9 text-global-10 hover:opacity-90 active:opacity-80 focus:ring-global-9',
  };
